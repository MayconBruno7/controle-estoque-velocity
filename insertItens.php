<?php
    ...
    try {
        ...
        if ($data) {
            return header("Location: listaItens.php?msgSucesso=Registro inserido com sucesso.");
        } else {
            return header("Location: listaItens.php?msgError=Falha ao tentar inserir o registro.");
        }
