    ...
    <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
            <div class="sidebar-brand">
                <a href="<?= Session::get('usuarioId') ? baseUrl() . Formulario::retornaHomeAdminOuHome() : '#' ?>"> <img alt="imagem" src="<?= baseUrl() ?>assets/img/brasao-pmrl.png" width="70" height="100" class="header-logo" /> 
                </a>
            </div>
            <?php if (Session::get('usuarioId') != false): ?>
