...
<div class="container">
    ...
    <div class="container" style="margin-top: 100px;">
        <?= Formulario::titulo('Peça', false, false) ?>
    </div>
    ...
    <form method="POST" action="<?= baseUrl() ?>Peca/<?= $this->getAcao() ?>">
        ...
        <div class="row">
            ...
            <div class="col-8">
                ...
                <input type="text" class="form-control" name="nome_peca" id="nome_peca" placeholder="Nome do item" required autofocus value="<?= setValor('nome_peca') ?>" <?= $this->getAcao() == 'view' || $this->getAcao() == 'delete' ? 'disabled' : '' ?>>
            </div>

            <div class="col-4">
                <label for="quantidade" class="form-label">Quantidade</label>
                <!--  verifica se a quantidade está no banco de dados e retorna essa quantidade -->
                <input type="number" class="form-control" name="qtd_item" id="quantidade" value="<?= setValor('quantidade') ?>" disabled >
            ...
            <div class="col-6 mt-3">
                <label for="valor_peca" class="form-label">Valor</label>
                <input type="text" class="form-control" name="valor_peca" id="valor_peca" value="<?= setValor('valor_peca') ?>">
            </div>

            <div class="col-12 mt-3">
                <label for="descricao_peca" class="form-label">Descrição</label>
                <textarea class="form-control" name="descricao_peca" id="descricao_peca" placeholder="Descrição do item" <?= $this->getAcao() == 'delete' || $this->getAcao() == 'view' ? 'disabled' : '' ?>><?= setValor('descricao_peca') ?></textarea>
            </div>
