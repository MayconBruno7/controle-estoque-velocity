...
class TgUpdateAdicionaHistoricoAtualizaQuantidadeProduto extends Migration
{
    public function up()
    {
        $this->db->query("
    ...
    {
        $this->db->query("DROP TRIGGER IF EXISTS tg_update_adiciona_historico_atualiza_quantidade_produto");
    }
}
