        ...
        <form class="g-3" action="<?= $_GET['acao'] ?>produtos.php" method="POST" id="form">
            ...
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <input type="text" class="form-control" name="nome" id="nome" placeholder="Nome do item" required autofocus value="<?= isset($dados->nome) ? $dados->nome : "" ?>">
                </div>
                ...
                <div class="col-3 mt-3">
                    ...
                    <select name="condicao" id="condicao" class="form-control" required <?= isset($_GET['acao']) && $_GET['acao'] != 'insert' && $_GET['acao'] != 'update' ? 'disabled' : ''?>>
